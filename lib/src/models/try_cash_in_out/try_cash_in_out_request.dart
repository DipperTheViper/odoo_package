...
class TryCashInOutRequest {
  ...
  factory TryCashInOutRequest.fromRawJson(String str) =>
      TryCashInOutRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TryCashInOutRequest.fromJson(Map<String, dynamic> json) =>
      TryCashInOutRequest(
        model: json["model"],
        method: json["method"],
        args: json["args"] == null
...
class CashArgClass {
  ...
  factory CashArgClass.fromRawJson(String str) =>
      CashArgClass.fromJson(json.decode(str));
