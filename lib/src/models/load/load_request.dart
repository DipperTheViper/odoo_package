...
class LoadRequest {
  ...
  factory LoadRequest.fromRawJson(String str) =>
      LoadRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LoadRequest.fromJson(Map<String, dynamic> json) => LoadRequest(
        actionId: json["action_id"],
        additionalContext: json["additional_context"] == null
            ? null
            : AdditionalContext.fromJson(json["additional_context"]),
      );
...
class AdditionalContext {
  ...
  factory AdditionalContext.fromRawJson(String str) =>
      AdditionalContext.fromJson(json.decode(str));
